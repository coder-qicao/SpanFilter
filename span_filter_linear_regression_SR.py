...
from super_resolution import super_resolution_bicubic_gaussian as F1, super_resolution_bicubic_mean as F2
...
# 读取低分辨率图像
lr_img = io.imread(lr_image_path)
...
# 读取高分辨率目标图像
hr_img = io.imread(hr_image_path)
